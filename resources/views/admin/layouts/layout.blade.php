		...
		<nav id="sidebar" class="sidebar js-sidebar">
          ...
          <span class="align-middle">Admin Panel</span>
				...
				<ul class="sidebar-nav">
					...
					<li class="sidebar-item {{request()->routeIs('post.create')?'active':''}}">
						<a class="sidebar-link" href="{{route('post.create')}}">
                         <i class="align-middle" data-feather="plus"></i> 
						 <span class="align-middle">Create</span>
                        </a>
					</li>
					<li class="sidebar-item {{request()->routeIs('post.manage')?'active':''}}">
						<a class="sidebar-link" href="{{route('post.manage')}}">
                         <i class="align-middle" data-feather="list"></i> 
						 <span class="align-middle">Manage</span>
                        </a>
					</li>
                ...
                <img src="img/avatars/avatar.jpg" class="avatar img-fluid rounded me-1" alt="Charles Hall" /> <span class="text-dark">Charles Hall</span>
							...
							<div class="dropdown-menu dropdown-menu-end">
								...
								<form action="{{route('logout')}}" method="POST">
									@csrf
									<input type="submit" class="text-center btn btn-warning" value="Logout">
								</form>
							</div>
						</li>
					</ul>
